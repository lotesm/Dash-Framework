    ...
    <section id="cta5-1" class="p-y-lg content-align-md center-md bg-edit bg-white">
        <div class="container">
            <div class="row y-middle">
                <div class="col-md-6 m-b wow zoomIn text-blue" style="visibility: hidden; animation-name: none;">
                    <?php check_message(); ?>
                    <h3 class="title">Password resert</h3>
                    <p>To reset your password enter your student number below</p>
                    <div style="height: 40px;"></div>
                    <form method="POST">

                        <div class="from-group col-md-12">
                            <label class="control-label" for="basicinput">Student Number</label>
                            <div class="controls">
                                <input data-title="A tooltip for the input" type="text" name="stud_number" placeholder="Student Number" data-original-title="" class="form-control form-control-sm" required="required" >
                            </div>
                        </div>
                        ...
                        <div class="from-group col-sm-12">
                            <center>
                                <button class="btn btn--radius btn--green btn-blue" type="submit" name="btnReset">Submit</button>
                                <a class="text-blue small" href="login.php">Or login</a>
                            </center>
