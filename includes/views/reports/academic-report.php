					...
					<td><ul class="na nav-pill">
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="#"><span class = "glyphicon glyphicon-eye-open"></span> View Student</a></li>

								<li><a href="#"><span class = "glyphicon glyphicon-eye-open"></span> View Report</a></li>
